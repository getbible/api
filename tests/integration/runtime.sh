...
it_check "bad reference 404"         "404"                       "$(it_status "$Q" /v2/test/nonsense)"
...
it_check "unknown short translation 404" "404"                    "$(it_status "$Q" /nope/Ge1:1)"
...
it_check "version root needs reference" "404"                     "$(it_status "$Q" /v2)"
it_check "translation needs reference" "404"                      "$(it_status "$Q" /v2/test)"
it_check "short translation needs reference" "404"                "$(it_status "$Q" /test)"
it_check "invalid shorthand stays 404" "404"                      "$(it_status "$Q" /nonsense)"
it_check "invalid shorthand has no redirect" ""                  "$(it_header "$Q" /nonsense location)"
