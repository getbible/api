...
- **Pages and OpenAPI**: every endpoint has a documentation page at `/vN/`
  ...
  its endpoints, `versions.json` maps them to their documents, and one favicon
  serves every domain. Each is generated by the tool, taken over by the
...
| [docs/PAGES.md](docs/PAGES.md) | documentation pages, OpenAPI documents, favicon, versions.json |
